...
activity_level = st.selectbox(
        "Activity Level",
        ["Sedentary: Little to no exercise (desk job)", "Lightly Active: Light exercise 1-3 days/week", "Moderately Active: Moderate exercise 3-5 days/week", "Very Active: Hard exercise 6-7 days/week", "Extra Active"]
    )
...
plt.title('Daily Water Intake Comparison')
for bar in bars:
